...
async function loginAndSignUp(userDetails, signUpMode) {
    let url ='';
    if(signUpMode){
        url ="https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBxmN7U0TnbCcdz-VjYAe4liAz7oYG6wlQ";

    }else{
        url ="https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBxmN7U0TnbCcdz-VjYAe4liAz7oYG6wlQ";
    }
    try {
